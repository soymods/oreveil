...
Run this on each released target jar with ProtocolLib installed. At minimum, smoke test Paper `1.16.5`, Paper `1.18.2`, the oldest supported `1.21` runtime, and the newest available `1.21.x` runtime for the release.
